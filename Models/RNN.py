...
def base_dnn(matrix, true_value, hours=6, set_size=0.5):
    ...
    checkpoint_path = "rnn_checkpoints/all_avoid.ckpt"
    ...
    history = model.fit(
        ...
        verbose=0,
        epochs=4000
        , callbacks=[keras.callbacks.EarlyStopping(monitor='val_loss', patience=60), cp_callback]
    )
    """
    #plot_loss(history)
    print("original")
